...
import {dataMenu, MenuAcceso} from './menu_accesos';
import {UserService} from "../../../../modules/configuration/user/services/user.service";
...
export class ClassyLayoutComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._userService.getInfo().subscribe((data)=>{
            // @ts-ignore
            this.userInfo = data;
        })
