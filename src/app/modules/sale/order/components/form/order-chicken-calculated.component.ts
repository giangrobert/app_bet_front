...
@Component({
    selector: 'app-order-chicken-calculated',
    standalone: true,
    imports: [
...
export class OrderChickenCalculatedComponent implements OnInit {
    @Input() title: string = '';
    @Input() data: any = '';
    abcForms: any;
    form = new FormGroup({
    ...
    constructor(
        private _matDialog: MatDialogRef<OrderChickenCalculatedComponent>
    ) {
    }
